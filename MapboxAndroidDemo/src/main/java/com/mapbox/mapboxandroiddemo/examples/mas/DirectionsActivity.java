...
public class DirectionsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // SNW building at Massey Uni Albany Campus
    final Position origin = Position.fromCoordinates(174.701910, -36.733756);

    // Study Centre building at Massey Uni Albany Campus
    final Position destination = Position.fromCoordinates(174.700805, -36.731609);
    ...
    mapView.getMapAsync(new OnMapReadyCallback() {
      ...
      public void onMapReady(MapboxMap mapboxMap) {
        ...
        mapboxMap.addMarker(new MarkerOptions()
          ...
          .title("Origin")
          .snippet("SNW Lecture Theatre"));
        mapboxMap.addMarker(new MarkerOptions()
          .position(new LatLng(destination.getLatitude(), destination.getLongitude()))
          .title("Destination")
          .snippet("Massey Business School (a.k.a. Study Centre)"));
